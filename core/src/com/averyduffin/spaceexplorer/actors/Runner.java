...
public class Runner extends GameActor{
	...
	public Runner(Body body){
        ...
        //testTexture = new TextureRegion(new Texture(Gdx.files.internal("test.png")));
        //userData.setWidth(jumpingTexture.getRegionWidth());
        //userData.setHeight(jumpingTexture.getRegionHeight());
	}
	 @Override
